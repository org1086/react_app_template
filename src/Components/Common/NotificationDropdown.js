                        ...
                        <div className="p-3">
                            <Row className="align-items-center">
                                ...
                                <div className="col-auto dropdown-tabs">
                                    <span className="badge badge-soft-light fs-13"> 3 Tin mới</span>
                                </div>
                            </Row>
                        </div>
                            ...
                            <SimpleBar style={{ maxHeight: "300px" }} className="pe-2">
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative active">
                                    ...
                                    <div className="avatar-xs me-3">
                                        ...
                                        <div className="flex-1">
                                            <Link to="#" className="stretched-link"><h6 className="mt-0 mb-1 fs-13 fw-semibold"></h6></Link>
                                            <div className="fs-13 text-muted">
                                                <p className="mb-1">Đơn vị A cập nhật tình hình ATTT
                                                  🔔.</p>
                                            </div>
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="mdi mdi-clock-outline"></i> 8 phút trước</span>
                                            </p>
                                        </div>
                                        <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-1">
                                            <Link to="#" className="stretched-link">
                                                <h6 className="mt-0 mb-2 fs-13 lh-base">Đơn vị B cập nhật tình hình ATTT <b className="text-success"></b> </h6>
                                            </Link>
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="mdi mdi-clock-outline"></i> 2 phút trước</span>
                                            </p>
                                        </div>
                                        <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
                                ...
                                <div className="text-reset notification-item d-block dropdown-item position-relative">
                                    ...
                                    <div className="avatar-xs me-3">
                                        ...
                                        <div className="flex-1">
                                            <Link to="#" className="stretched-link"><h6 className="mt-0 mb-1 fs-13 fw-semibold"></h6></Link>
                                            <div className="fs-13 text-muted">
                                                <p className="mb-1">Đơn vị C cập nhật tình hình ATTT.</p>
                                            </div>
                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                <span><i className="mdi mdi-clock-outline"></i> 4 phút trước</span>
                                            </p>
                                        </div>
                                        <div className="px-2 fs-15">
                                            <div className="form-check notification-check">
