                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link to="/" className="d-inline-block auth-logo">
                                            <img src={logoPreview} alt="" height="100" />
                                        </Link>
                                    </div>
                                    <p className="mt-3 fs-20 fw-medium">HỆ THỐNG TỔNG HỢP, ĐIỀU HÀNH TẠI SCH </p>
                                </div>
                            </Col>
                        </Row>
                                        ...
                                        <div className="p-2 mt-4">
                                            <Form
                                                ...
                                                <div className="form-check">
                                                    ...
                                                    <Label className="form-check-label" htmlFor="auth-remember-check">Ghi nhớ mật khẩu</Label>
                                                </div>

                                                <div className="mt-4">
                                                    <Button color="success" className="btn btn-success w-100" type="submit">Đăng nhập</Button>
                                                </div>
