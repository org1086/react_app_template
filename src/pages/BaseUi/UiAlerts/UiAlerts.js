                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="warning" className="alert-outline fs-20 ">
                                                    <strong>SỰ KIỆN, VỤ VIỆC  </strong>  
                                                </UncontrolledAlert>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <h6>Secondary Alert</h6>
                                                <UncontrolledAlert color="secondary" className="alert-border-left fs-20">
                                                    <strong>KẾT QUẢ TÁC CHIẾN THÔNG TIN</strong>
                                                 
                                                </UncontrolledAlert>

                                                <h6>Success Alert</h6>
                                                <UncontrolledAlert color="success" className="alert-border-left fs-20">
                                                   <strong>TRANG CỔNG THÔNG TIN ĐIỆN TỬ</strong>
                                                 
                                                </UncontrolledAlert>

                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger" className="alert-border-left mb-xl-0 fs-20">
                                                   <strong>MẤT KẾT NỐI FMC</strong>
                                            ...
                                            <Col xl={6}>
                                                <h6>Warning Alert</h6>
                                                <UncontrolledAlert color="warning" className="alert-border-left fs-20">
                                                  <strong>TÌNH HÌNH NHIỄM MÃ ĐỘC MỨC CAO </strong>
                                                   
                                                </UncontrolledAlert>

                                                <h6>Info Alert</h6>
                                                <UncontrolledAlert color="info" className="alert-border-left fs-20">
                                                    <strong>DẤU HIỆU MẤT AN TOÀN THÔNG TIN</strong>                                                    
                                                </UncontrolledAlert>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={12}>
                                                <h6>Primary Alert</h6>
                                                <UncontrolledAlert color="primary" className="alert-solid alert-label-icon fs-20" closeClassName="btn-close-white">
                                                    <strong>TÌNH HÌNH TRÊN MẠNG INTERNET</strong> 
                                                </UncontrolledAlert>

                                                <h6>Secondary Alert</h6>
                                                <UncontrolledAlert color="secondary" className="alert-solid alert-label-icon fs-20" closeClassName="btn-close-white" >
                                                <strong>TÌNH HÌNH TRÊN MẠNG MÁY TÍNH QUÂN SỰ</strong>
