...
import { DefaultButtonsExample, OutlineButtonsExample, RoundedButtonsExample, SoftButtonsExample, GradientButtonsExample, AnimationButtonsExample, LabelButtonsExample, SizeButtonsExample, WidthButtonsExample, TagButtonsExample, GridButtonsExample, CheckButtonsExample, GroupButtonsExample, IconButtonsExample, ToolbarButtonsExample, GroupsizingButtonsExample, VerticalButtonsExample, GhostButtonsExample, LoadingbuttonsExample, BorderButtonsExample } from './UiButtonCode';
                                        ...
                                        <Row>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                    ...
                                                    <Button color="success" className="btn-label"> <i className="ri-file-download-line label-icon align-middle fs-16 me-2"></i> EXCEL </Button>
                                                    <Button color="danger" className="btn-label"> <i className="ri-file-download-line label-icon align-middle fs-16 me-2"></i> PDF </Button>
                                                </div>
                                            </Col>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                <div className="hstack gap-2 ">
                                                    ...
                                                    <Button color="danger" className="btn-icon"> <i className=" ri-file-download-line" /> </Button>
