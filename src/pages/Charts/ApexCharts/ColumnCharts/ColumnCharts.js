...
const BasicColumn1 = ({ dataColors }) => {
    ...
    const series = [
        ...
        {
            name: "Trang cổng hoạt động bình thường",
            data: [43, 38, 25,13],
        },
        {
            name: "Trang cổng gặp sự cố",
            data: [14, 18, 10,7],
        },
    ...
    var options = {
        ...
        xaxis: {
            categories: ['Tổng cộng', 'Lữ đoàn 1', 'Lữ đoàn 2', 'Lữ đoàn 3'],
        },
        yaxis: {
            title: {
                text: ''
...
const BasicColumn = ({ dataColors }) => {
    ...
    var options = {
        ...
        colors: chartColumnColors,
        xaxis: {
            categories: ['Radar', 'RadarCY', 'Tường lửa', 'Máy chủ'],
        },
        yaxis: {
            title: {
                text: ''
...
const StackedColumn1 = ({ dataColors }) => {
    var chartColumnStackedColors = getChartColorsArray(dataColors);
    const series = [
        {
            name: "HVQY",
...
const DistributedColumn2 = ({ dataColors }) => {
    var chartColumnDistributedColors = getChartColorsArray(dataColors);
    const series = [{
        data: [21, 22, 18]
    }];
...
const DistributedColumn1 = ({ dataColors }) => {
    var chartColumnDistributedColors = getChartColorsArray(dataColors);
    const series = [{
        data: [21, 22, 10, 18, 16, 21, 13,]
    }];
    var options = {
        chart: {
            height: 350,
