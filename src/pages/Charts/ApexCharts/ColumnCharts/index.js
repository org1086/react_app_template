                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                <CardHeader>
                                    <h4 className="card-title mb-0">So sánh 10 ngày</h4>
                                </CardHeader>
                                <CardBody>
                                    <BasicColumn dataColors='["--vz-success","--vz-danger" ]' />
                                </CardBody>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <StackedColumn dataColors='[ "--vz-success", "--vz-warning", "--vz-danger"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                <CardHeader>
                                    <h4 className="card-title mb-0">Liên quan sự việc 1</h4>
                                </CardHeader>
                                <CardBody>
                                    <DistributedColumn dataColors='[ "--vz-primary","--vz-dark",   "--vz-success", "--vz-dark"]' />
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
