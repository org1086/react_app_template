...
//Stacked Line Chart , 'Union Ads', 'Video Ads', 'Direct', 'Search Engine'
const StackedLineChart = ({ dataColors }) => {
    ...
    var option = {
        ...
        legend: {
            data: ['Tình hình trang cổng TTĐT'],
        ...
        xAxis: {
            type: 'category',
            boundaryGap: false,
            data: ['2/12/2022', '3/12/2022', '4/12/2022', '5/12/2022', '6/12/2022', '7/12/2022'],
            axisLine: {
                lineStyle: {
                    color: '#858d98'
                },
