                ...
                <Col xs={12}>
                    <Card>
                        <CardBody className="p-0">
                            <Alert className="alert alert-info border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                {/* <FeatherIcon
                                    icon="alert-triangle"
                                    className="text-warning me-2 icon-sm"
                                /> */}
                                <div className="flex-grow-1 text-truncate fs-24 text-decoration-boild">
