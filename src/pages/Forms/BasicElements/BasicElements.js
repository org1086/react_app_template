...
const BasicElements = () => {
            ...
            <div className="page-content">
                <Container fluid>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <PreviewCardHeader title="Quân số" />
                                ...
                                <CardBody className="card-body">
                                    <div className="live-preview">
                                        <Row className="gy-4">
                                            {/* <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="basiInput" className="form-label">Đạn biên chế  </Label>
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="labelInput" className="form-label">Súng biên chế</Label>
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="placeholderInput" className="form-label">Đạn biên chế </Label>
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="exampleInputdate" className="form-label">Ngày giờ</Label>
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="exampleFormControlTextarea5" className="form-label">Chú giải</Label>
 ...
 {/* <Col xxl={3} md={6} >
                                                <select className="form-select mb-3" aria-label="Default select example">
                                                    ...
                                                    <option value="2">RouterCY</option>
                                                    <option value="3">Tường lửa </option>
                                                    <option value="3">Máy chủ </option>
                                                </select>
                                            </Col> */}
                                             
                                               <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Hình ảnh</Label>
                                             ...
                                             <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Có mặt</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Tiêu đề lớn</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Đơn vị nhập</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Mục thông tin</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">số lượng tương tác thu hút</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Viện </Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Đi học</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Chờ hưu</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Thai sản</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Khác</Label>
                                                    <Input type="text" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Tổng số</Label>
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Số lượng tăng trong ngày</Label>
                                                    <Input type="password" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="exampleInputtime" className="form-label">Thời gian  </Label>
                                                    <Input type="time" className="form-control" id="exampleInputtime" />
                                                </div>
                                            </Col>
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Nguyên nhân</Label>
                                                    <Input type="password" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Tình trạng xử lý</Label>
                                                    <Input type="password" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="exampleInputtime" className="form-label">Thời gian xử lý </Label>
                                                    <Input type="time" className="form-control" id="exampleInputtime" />
                                                </div>
                                            </Col>
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Đơn vị xử lý</Label>
                                                    <Input type="password" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
                                            ...
                                            <Col xxl={3} md={6}>
                                                <div>
                                                    <Label htmlFor="formtextInput" className="form-label">Đơn vị quản lý</Label>
                                                    <Input type="password" className="form-control" id="formtextInput" />
                                                    <div id="passwordHelpBlock" className="form-text">
