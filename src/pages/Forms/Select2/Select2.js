...
const Select2 = () => {
    ...
    const sortbyname = [
        {
            options: [
                { label: "TÌNH HÌNH HOẠT ĐỘNG VKTB", value: "AL" },
                { label: "HẠ TẦNG MẠNG", value: "MA" },
                { label: "ỨNG DỤNG DỊCH VỤ DÙNG CHUNG", value: "TO" },
                { label: "ATTT: Vi phạm kết nối Internet", value: "LO" },
                { label: "ATTT: Tình hình nhiễm mã độc mức cao", value: "WY" },
                { label: "ATTT: Tình hình kết nối FMC", value: "WYe" },
                { label: "ATTT: Dấu hiệu mất ATTT", value: "WYee" },
                { label: "ATTT: Định danh thiết bị MiAV", value: "WYee" },
                { label: "ATTT: Các Hệ thống CNTT quan trọng quốc gia", value: "WYee" },
                { label: "TRINH SÁT: Tình hình trên KGM", value: "WYee" },
                { label: "TRINH SÁT: Thông tin tiêu cực nổi bật", value: "WYee" },
                { label: "TRINH SÁT: Các thông tin khác", value: "WYee" },
            ],
        },
    ];
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <Row className="g-4">
                                        <Col lg={4}>
                                            <h6 className="fw-semibold">Lựa chọn điền các Thông tin</h6>
                                            <Select
                                                value={sortBy}
                                                onChange={(sortBy) => {
                                                    setsortBy(sortBy);
