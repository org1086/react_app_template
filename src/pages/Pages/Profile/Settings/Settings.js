                            ...
                            <Card className="mt-n5">
                                <CardBody className="p-4">
                                    <div className="text-center">
                                        ...
                                        <h5 className="fs-16 mb-1">TBTC</h5>
                                        <p className="text-muted mb-0">Trợ lý / BTL86</p>
                                    </div>
                                </CardBody>
                            </Card>
                                        ...
                                        <TabPane tabId="1">
                                            <Form>
                                                <Row>
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            ...
                                                            <Input type="text" className="form-control" id="firstnameInput"
                                                                placeholder="Nhập họ tên" defaultValue="Dave" />
                                                        </div>
                                                    </Col>
                                                    {/* <Col lg={6}>
                                                        <div className="mb-3">
                                                    ...
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="phonenumberInput" className="form-label">Số ĐT</Label>
                                                            <Input type="text" className="form-control"
                                                                id="phonenumberInput"
                                                                placeholder="Nhập số ĐT"
                                                                defaultValue="+(84) 987 6543" />
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="skillsInput" className="form-label">Chức vụ</Label>
                                                            <select className="form-select mb-3">
                                                                <option >Lựa chọn chức vụ </option>
                                                                <option value="Choices1">Trợ lý</option>
                                                                <option value="Choices2">Nghiên cứu viên</option>
                                                                <option value="Choices3">Sĩ quan hành động</option>
                                                                <option value="Choices4">Trường phòng</option>                                                               
                                                            </select>
                                                        </div>
                                                    </Col>
                                                    <Col lg={6}>
                                                        <div className="mb-3">
                                                            <Label htmlFor="designationInput"
                                                                className="form-label">Đơn vị</Label>
                                                            <Input type="text" className="form-control"
                                                                id="designationInput" placeholder="Phòng/ Ban"
                                                                defaultValue="PTM / BTL 86" />
                                                        </div>
                                                    </Col>
                                                    {/* <Col lg={6}>
                                                        <div className="mb-3">
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="hstack gap-2 justify-content-end">
                                                            ...
                                                            <button type="button"
                                                                className="btn btn-soft-success">Hủy</button>
                                                        </div>
                                                    </Col>
                                                </Row>
                                            </Form>
                                            ...
                                            <Form>
                                                <Row className="g-2">
                                                    ...
                                                    <Col lg={12}>
                                                        <div className="mb-3">
                                                            <Link to="#"
                                                                className="link-primary text-decoration-underline">Quên mật khẩu ?</Link>
                                                        </div>
                                                    </Col>

                                                    <Col lg={12}>
                                                        <div className="text-end">
                                                            <button type="button" className="btn btn-success">Đổi mật khẩu</button>
                                                        </div>
                                                    </Col>
