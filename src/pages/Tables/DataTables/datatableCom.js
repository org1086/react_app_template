...
const AjaxDatatables = () => {
    const columns = [
        ...
        {
            name: <span className='font-weight-bold fs-13'>Ngày nhập</span>,
            selector: row => row.startDate1,
            sortable: true
        },
        {
            name: <span className='font-weight-bold fs-13'>Đơn vị nhập</span>,
        ...
        {
            name: <span className='font-weight-bold fs-13'>Mục thông tin</span>,
            selector: row => row.extn1,
            sortable: true
        },
        {
