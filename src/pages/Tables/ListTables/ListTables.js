...
const ListTables = () => {
    ...
    document.title = "Quản lý người dùng |Hệ thống IOC";

    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Quản lý người dùng" pageTitle="Hệ thống" />
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <div id="customerList">
                                        <Row className="g-4 mb-3">
                                            <Col className="col-sm-auto">
                                                <div>
                                                    <Button color="success" className="add-btn me-1" onClick={() => tog_list()} id="create-btn"><i className="ri-add-line align-bottom me-1"></i> Thêm</Button>
                                            ...
                                            <Col className="col-sm">
                                                <div className="d-flex justify-content-sm-end">
                                                    <div className="search-box ms-2">
                                                        <input type="text" className="form-control search" placeholder="Tìm kiếm..." />
                                            ...
                                            <table className="table align-middle table-nowrap" id="customerTable">
                                                <thead className="table-light">
                                                    <tr>
                                                        ...
                                                        <th className="sort" data-sort="customer_name">Họ tên</th>
                                                        <th className="sort" data-sort="email">Tên hiển thị</th>
                                                        <th className="sort" data-sort="phone">Đơn vị</th>                                                     
                                                        <th className="sort" data-sort="status">Quyền</th>
                                                ...
                                                <tbody className="list form-check-all">
                                                    <tr>
                                                        ...
                                                        <td className="email">marycousar</td>
                                                        <td className="phone">Tham mưu</td>                                                     
                                                        <td className="status"><span className="badge badge-soft-success text-uppercase">Người dùng</span></td>
                                                        <td>
                                                            <div className="d-flex gap-2">
                                                                <div className="edit">
                                                                    <button className="btn btn-sm btn-success edit-item-btn"
                                                                        data-bs-toggle="modal" data-bs-target="#showModal">Sửa</button>
                                                                </div>
                                                                <div className="remove">
                                                                    <button className="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal">Xóa</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td className="email">jefftaylor</td>
                                                        <td className="phone">Chính trị</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">robertmcmahon</td>
                                                        <td className="phone">Hậu cần</td>                                                      
                                                        <td className="status"><span className="badge badge-soft-success text-uppercase">Người dùng</span></td>
                                                        <td>
                                                            <div className="d-flex gap-2">
                                                                <div className="edit">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">michaelmorris</td>
                                                        <td className="phone">Văn phòng</td>
                                                   
                                                        <td className="status"><span className="badge badge-soft-danger text-uppercase">Admin</span></td>
                                                        <td>
                                                            <div className="d-flex gap-2">
                                                                <div className="edit">
                                                                    <button className="btn btn-sm btn-success edit-item-btn"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">kevindawson</td>
                                                        <td className="phone">TCH</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">carolynjones</td>
                                                        <td className="phone">Tham mưu</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">glenmatney</td>
                                                        <td className="phone">Văn phòng</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">charleskubik</td>
                                                        <td className="phone">Chính trị</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">herbertstokes</td>
                                                        <td className="phone">Tham mưu</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">timothysmith</td>
                                                        <td className="phone">KHQS</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="email">johnnyevans</td>
                                                        <td className="phone">Lữ 1</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="customer_name">Kevin Dawson</td>
                                                        <td className="email">kevindawso</td>
                                                        <td className="phone">Lữ 2</td>
            ...
            <Modal isOpen={modal_list} toggle={() => { tog_list(); }} centered >
                ...
                <form>
                    <ModalBody>
                        ...
                        <div className="mb-3">
                            <label htmlFor="customername-field" className="form-label">Họ tên</label>
                            <input type="text" id="customername-field" className="form-control" placeholder="Nhập họ tên" required />
                        </div>

                        <div className="mb-3">
                            <label htmlFor="email-field" className="form-label">Tên hiển thị</label>
                            <input type="email" id="email-field" className="form-control" placeholder="Tên hiển thị" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="customername-field" className="form-label">Đơn vị</label>
                            <input type="text" id="customername-field" className="form-control" placeholder="Nhập đơn vị" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="phone-field" className="form-label">Tên đăng nhập</label>
                            <input type="text" id="phone-field" className="form-control" placeholder="Tên đăng nhập" required />
                        </div>
                        ...
                        <div>
                            <label htmlFor="status-field" className="form-label">Quyền</label>
                    ...
                    <ModalFooter>
                        <div className="hstack gap-2 justify-content-end">
                            <button type="button" className="btn btn-light" onClick={() => setmodal_list(false)}>Đóng</button>
                            <button type="submit" className="btn btn-success" id="add-btn">Thêm</button>
                            <button type="button" className="btn btn-success" id="edit-btn">Cập nhật</button>
                        </div>
                    </ModalFooter>
                </form>
            </Modal>
                ...
                <ModalBody>
                    <div className="mt-2 text-center">
                        ...
                        <div className="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                            <h4>Are you Sure ?</h4>
                            <p className="text-muted mx-4 mb-0">Bạn có chắc chắn muốn xóa ?</p>
                        </div>
                    </div>
